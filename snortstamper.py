...
if __name__ == "__main__":
    ...
    transcript_file = "transcript.txt"  # Change this to your file path
    ...
    try:
        ...
        generator = ChapterGenerator(
            model="mistral",
            chunk_size=4000,  # ~1000 words, adjust if needed
            overlap=800       # Good overlap for context
        )
        ...
        # Print results
        print("\n" + "="*60)
        print("YOUTUBE CHAPTERS (Copy to description)")
        print("="*60)
        ...
        print("\n" + "="*60)
        print("✓ Saved to youtube_chapters.txt and chapters.json")
        
    except FileNotFoundError:
        print(f"Error: Could not find '{transcript_file}'")
        print("Usage: python script.py [transcript_file.txt]")
        sys.exit(1)
    except Exception as e:
        print(f"Error: {e}")
        sys.exit(1)